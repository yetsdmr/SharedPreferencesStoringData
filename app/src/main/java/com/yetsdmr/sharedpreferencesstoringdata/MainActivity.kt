package com.yetsdmr.sharedpreferencesstoringdata
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPreferences = this.getSharedPreferences("com.yetsdmr.sharedpreferencesstoringdata", Context.MODE_PRIVATE)
